...
========================================================================= */
    ...
    $('#tweet-list').hide();
    var user = 'livephoneanswer'; // Set your twitter id
    var count = '2'; // How many feeds do you want. Recommended Max 10 Twitter Api

    $.getJSON('http://api.twitter.com/1.1/statuses/user_timeline/livephoneanswer.json?screen_name=' + user + '&count=' + count + '&callback=?',
    function(tweetdata) {
        var tl = $("#tweet-list");
        $.each(tweetdata,
        function(i, tweet) {
